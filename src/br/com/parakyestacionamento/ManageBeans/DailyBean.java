...
public class DailyBean {
	...
	public void saveNewDaily(ActionEvent event){
		...
		try {
			...
			ParakyMessage.addErrorMessageSub("Erro ao salvar diária!"," Nao foi possivel inserir dado no banco de dados. Contate o administrador do sistema.");
	...
	public void searchForTicket(ActionEvent event){
		try {
			...
			if(ticket == null)
				ParakyMessage.addErrorMessageSub("Ticket inexistente!"," NÃºmero de indentificaÃ§Ã£o "+ idClosedTicket+" inexistente na base.");
			else{
				newDaily = ticket; 
