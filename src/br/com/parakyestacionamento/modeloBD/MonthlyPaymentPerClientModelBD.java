...
public class MonthlyPaymentPerClientModelBD implements BDModel{
	...
	public MonthlyPaymentPerClient bdToObject(ResultSet rs) throws SQLException {
		...
		monthlyPayment.setPaymentStatus(rs.getString(8));
