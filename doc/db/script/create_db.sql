...
CREATE SEQUENCE CAR_SEQUENCE START WITH 2 INCREMENT BY 1;
CREATE SEQUENCE CLIENT_SEQUENCE START WITH 3 INCREMENT BY 1;
CREATE SEQUENCE DAILY_SEQUENCE START WITH 2 INCREMENT BY 1;
CREATE SEQUENCE PARKING_SEQUENCE START WITH 2 INCREMENT BY 1;
CREATE SEQUENCE ADRESS_SEQUENCE START WITH 2 INCREMENT BY 1;
CREATE SEQUENCE MONTHLY_PAYMENT_SEQUENCE START WITH 3 INCREMENT BY 1;